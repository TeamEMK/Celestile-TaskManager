...
// Separate message for a designer who hasn't filled today's daily task at
// all — sent on its own to the design group, not folded into the summary
// above (which only ever lists designers who have entries to report).
export function designNotFilledMessage(name) {
