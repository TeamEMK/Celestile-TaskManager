...
export const SCHEMAS = {
  ...
  delegations: ['id', 'description', 'doer_id', 'doer', 'delegated_by', 'due_date', 'client', 'status', 'type', 'priority', 'approval', 'url', 'remarks', 'revise_action', 'transferred_by', 'transferred_from', 'created_at', 'completed_at', 'image'],
  ...
  fms_sheets: ['id', 'fms_name', 'sheet_name', 'sheet_id', 'header_row', 'created_by', 'created_at'],
  fms_steps: ['id', 'fms_id', 'step_order', 'step_name', 'plan_col', 'actual_col', 'extra_input', 'extra_col', 'show_cols', 'delay_reason_col', 'doer_name_col'],
...
export const PRIMARY_KEYS = {
  ...
  fms_sheets: ['id'], fms_steps: ['id'], fms_step_doers: ['step_id', 'user_id'],
  fms_extra_rows: ['id'], profile: ['user_id'],
