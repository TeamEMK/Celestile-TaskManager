...
const IMS_SHEET_ID = (process.env.IMS_SHEET_ID || '1dmAHEQAuau9HB5C2JGXfkHPN1vVEUf3tGT6aWBduG6E').trim();
...
const encodeId = (rowNum, o) => `R${rowNum}${SEP}${tok(o.slab)}${SEP}${tok(o.key)}`;
...
function invalidate() { g.__imsCache = { rows: null, at: 0 }; }
