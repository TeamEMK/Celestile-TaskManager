      ...
      <div className="px-2 pb-3 pt-2 border-t border-slate-800/80 shrink-0">
        <div className="flex items-center gap-2.5 px-1.5 py-1.5 rounded-lg hover:bg-slate-800/60">
          ...
          <div className="min-w-0 flex-1 opacity-0 group-hover/sb:opacity-100 transition-opacity duration-200">
            <div className="text-[12px] font-medium text-white truncate whitespace-nowrap">Tushar Singh</div>
            <div className="text-[10px] text-slate-400 truncate whitespace-nowrap">Admin · Operations</div>
          </div>
          <button className="text-slate-500 hover:text-white p-1 rounded-md hover:bg-slate-700/60 opacity-0 group-hover/sb:opacity-100 transition-opacity duration-200" title="Sign out">
